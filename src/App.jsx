    ...
    <div className="app">
      ...
      <footer className="footer">
        <div className="social-links">
          <a href="https://www.instagram.com/kurtadodoli" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="social-link">
          ...
          <a href="https://github.com/kurtadodoli" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <a href="https://www.linkedin.com/in/kurt-adodoli-880935317/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-link">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
